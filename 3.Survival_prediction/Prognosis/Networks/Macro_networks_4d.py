...
# def regularize_path_weights(model, reg_type=None):
#     l1_reg = None
#     for W in model.fc.parameters():  # Remove .module from here
#         if l1_reg is None:
#             l1_reg = torch.abs(W).sum()
...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = nn.Conv3d(7, self.inplanes, kernel_size=7, stride=(1,2,2), padding=(3,3,3),
                               bias=False)
        ...
        # self.bn2 = nn.BatchNorm3d(self.feature_dim)
        self.relu2 = nn.ReLU()
